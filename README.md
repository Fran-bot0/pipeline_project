...
Currently, the pipeline up until returning the bam files for analysis should work with any user input as long as the organism exists in ensembl and the accession(s) exist in NCBI. However, the graphs.py scrip is hard-coded to work with the organism and accessions used in this [study.]([https://pages.github.com/](https://doi.org/10.3389/fmicb.2024.1394880))
