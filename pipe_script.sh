...
# Asking the user whihc organism the pipeline will run with and making the necessary directories if none exist
...
# Downloads the primary assembly of the specified organism from Ensembl. If the primary assembly doesn't exist, it downloads the toplevel file
# Also doenloads the gtf and the vcf files
